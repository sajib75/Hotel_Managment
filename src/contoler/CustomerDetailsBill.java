...
public class CustomerDetailsBill extends javax.swing.JFrame {
    ...
    public CustomerDetailsBill() {
        initComponents();
        SimpleDateFormat myFormet = new SimpleDateFormat("yyyy/MM/dd");
        Calendar cal = Calendar.getInstance();
        jTextField1.setText(myFormet.format(cal.getTime()));
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1310, 680));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1310, 680));
        ...
        jLabel1.setText("Customet Details Bill");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 245, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 10, 32, 24));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 60, 195, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 60, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Mobile Number ", "Nationalty", "Gender", "Email", "IDProof", "Address", "Check IN Date", "Room Number", "Bed", "RoomType", "Price par Day", "Number of Daye Stay", "Total Amount", "Check Out Date"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 1211, 367));

        jLabel4.setFont(new java.awt.Font("Algerian", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 0, 0));
        jLabel4.setText("*Click on table row to open bill");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 550, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/all pages background.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 1570, 640));
